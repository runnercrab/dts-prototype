// scripts/paso10-validate-gedeth.mjs
//
// Paso 10 — Validación snapshot ↔ live (solo gedeth).
...
//
// Uso:
//   node scripts/paso10-validate-gedeth.mjs
//
// Requiere:
...
// ─── 2) Inputs hardcoded (solo gedeth para Paso 10) ──────────────────
const ASSESSMENT_ID = "0acbb131-a98f-4ac7-997f-aa1e30d722c2";
const SNAPSHOT_ID   = "9389a349-eae0-4eba-aba1-1489da916e04";
...
async function main() {
  ...
  const lines = [];
  lines.push("=== Paso 10 — gedeth snapshot ↔ live (summary-only) ===");
