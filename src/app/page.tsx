        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="card" style={{ borderTop: '4px solid #2563eb' }}>
            <div className="card-body">
              ...
              <p className="mb-4" style={{ color: '#475569' }}>
                Evaluación completa basada en <strong>TM Forum DMM v5.0.1</strong>. 
                Analiza 6 dimensiones clave de tu organización: Customer, Strategy, Technology, 
                Operations, Culture y Data.
              </p>
          ...
          <div className="card" style={{ borderTop: '4px solid #64748b' }}>
            <div className="card-body">
              ...
              <p className="mb-4" style={{ color: '#475569' }}>
                Evaluación especializada de gobernanza, calidad y monetización de datos. 
                Basada en estándares internacionales de gestión de datos.
              </p>
              
              <ul className="space-y-2 mb-6" style={{ color: '#64748b' }}>
                <li className="flex items-start gap-2">
                  <span>○</span>
          ...
          <div className="card" style={{ borderTop: '4px solid #64748b' }}>
            <div className="card-body">
              ...
              <p className="mb-4" style={{ color: '#475569' }}>
                Preparación guiada para certificaciones ISO 27001 (Seguridad), 
                ISO 9001 (Calidad) y otros estándares internacionales.
              </p>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr style={{ borderBottom: '2px solid #e2e8f0' }}>
                  <th className="text-left py-3 px-4 font-bold text-lg" style={{ color: '#0f172a' }}>Paso</th>
                  <th className="text-left py-3 px-4 font-bold text-lg" style={{ color: '#0f172a' }}>Qué hace</th>
                  <th className="text-left py-3 px-4 font-bold text-lg" style={{ color: '#0f172a' }}>Qué obtienes</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      >1</div>
                      <span className="font-semibold" style={{ color: '#0f172a' }}>Conversa con tu asesor digital</span>
                    </div>
                  </td>
                  <td className="py-4 px-4" style={{ color: '#475569' }}>
                    El avatar te hace preguntas simples sobre cómo gestionas tu empresa.
                  </td>
                  <td className="py-4 px-4 font-semibold" style={{ color: '#0f172a' }}>Contexto real de tu negocio</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <div 
                        ...
                        style={{ width: '32px', height: '32px', background: '#2563eb', fontSize: '16px' }}
                      >2</div>
                      <span className="font-semibold" style={{ color: '#0f172a' }}>Analiza tu situación actual</span>
                    </div>
                  </td>
                  <td className="py-4 px-4" style={{ color: '#475569' }}>
                    Gapply compara tus respuestas con las mejores prácticas internacionales.
                  </td>
                  <td className="py-4 px-4 font-semibold" style={{ color: '#0f172a' }}>Diagnóstico completo</td>
                </tr>
                <tr>
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <div 
                        ...
                        style={{ width: '32px', height: '32px', background: '#2563eb', fontSize: '16px' }}
                      >3</div>
                      <span className="font-semibold" style={{ color: '#0f172a' }}>Recibe tu plan de acción</span>
                    </div>
                  </td>
                  <td className="py-4 px-4" style={{ color: '#475569' }}>
                    Plan personalizado 30/60/90 días con acciones concretas priorizadas.
                  </td>
                  <td className="py-4 px-4 font-semibold" style={{ color: '#0f172a' }}>Roadmap de transformación</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-6">
            <div className="border-b pb-6" style={{ borderColor: '#e2e8f0' }}>
              ...
              <p style={{ color: '#475569' }}>
                La evaluación completa toma entre 45-60 minutos. Puedes guardar tu progreso y 
                continuar más tarde. El avatar te guía paso a paso para que sea un proceso ágil y claro.
              </p>
            </div>
            ...
            <div className="border-b pb-6" style={{ borderColor: '#e2e8f0' }}>
              ...
              <p style={{ color: '#475569' }}>
                No. Gapply está diseñado para CEOs, directores y propietarios de negocios. 
                Las preguntas están en lenguaje claro, sin jerga técnica. El avatar te ayuda 
                a entender cada concepto.
              </p>
            </div>
            ...
            <div className="border-b pb-6" style={{ borderColor: '#e2e8f0' }}>
              ...
              <p style={{ color: '#475569' }}>
                Recibes un roadmap personalizado 30/60/90 días con acciones concretas priorizadas 
                por impacto y esfuerzo. Incluye Quick Wins (victorias rápidas) y proyectos transformacionales 
                de mayor alcance.
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ color: '#475569' }}>
                No. Gapply está especialmente diseñado para PYMEs. Utilizamos la misma metodología 
                profesional que usan empresas Fortune 500, pero adaptada a las realidades y presupuestos 
      ...
      >
        <div className="card-body text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Descubre dónde está tu empresa, qué mejorar primero y cómo lograrlo en 90 días.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              ...
              style={{ background: 'white', color: '#2563eb', fontWeight: 'bold', border: 'none' }}
            >
              Comenzar Evaluación Gratuita →
            </Link>
            
            <p className="text-sm opacity-75">
              ✓ Sin tarjeta de crédito · ✓ 45-60 minutos · ✓ Resultados inmediatos
            </p>
          </div>
        </div>
      </div>
